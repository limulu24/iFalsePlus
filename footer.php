<div class="container-full footer">
    <div class="container footer-box">
        ...
        <script type="text/javascript">
            ...
            runtime_box.innerHTML="本站已存活: "+A+"天"+B+"小时"+C+"分"+D+"秒"}show_runtime();
        </script>
        <?php } ?>
        ...
        <div class="author">
            ...
            <div>Powered by <a href="https://wordpress.org/">WordPress</a> Theme by <a href="https://github.com/limulu24/iFalsePlus">iFalsePlus</a></div>
        </div>
        

        <?php //自定义底部代码 ?>
        <?php if($footer_html = get_option('i_footer_html')): ?>
