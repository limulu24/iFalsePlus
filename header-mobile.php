        ...
        <div class="menu-mb-box">
            ...
            <div class="visitor">
                    <div class="site-brand">
                        <?php if(get_option('i_logo_mobile')): ?>
                            <img class="site-logo" src="<?php echo get_option('i_logo_mobile'); ?>" alt="<?php bloginfo('name'); ?>">
                        <?php else: ?>
                            <img class="site-logo" src="<?php site_icon_url(); ?>" alt="<?php bloginfo('name'); ?>">
                        <?php endif; ?>
                        <div class="site-info">
                            <h1 class="site-text"><?php bloginfo('name'); ?></h1>
                            <h1 class="site-text site-text-sub"><?php echo get_option('i_mobile_slogan') ?: bloginfo('description'); ?></h1>
                        </div>
                    </div>
                </div>
                <!-- end -->
